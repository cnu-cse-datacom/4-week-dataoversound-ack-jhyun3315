...
def make_sound(to_hz):
    to_hz = [i*STEP_HZ+START_HZ for i in to_hz]
    to_hz.insert(0,HANDSHAKE_START_HZ)
    to_hz.append(HANDSHAKE_END_HZ)
...
def extract_packet(freqs):
    ...
    return bytearray(decode_bitchunks(BITS, bit_chunks)),bit_chunks[20:]
